...
export default function ToggleThemeBtn() {
  ...
  return (
    <button className='flex p-2 group' onClick={toggleTheme}>
      <span className='mr-4 text-sm font-bold transition-colors duration-300 text-secondary group-hover:text-fill-hover'>
        {darkMode ? 'LIGHT' : 'DARK'}{' '}
      </span>
      {darkMode ? (
        <svg
          className='w-5 h-5 transition-colors duration-300 group-hover:fill-fill-hover fill-fill'
