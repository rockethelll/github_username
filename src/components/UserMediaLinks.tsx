...
export const UserMediaLinks = ({ data }: { data: User }) => {
  return (
    <ul className='grid grid-cols-1 gap-4 md:grid-cols-2'>
      <li
        className={`flex gap-6 md:order-1 ${
          data.location ? 'text-svg' : 'text-svg-disabled/50 italic'
        }`}
      >
        <svg
          height='20'
          ...
          className={data.location ? 'fill-svg' : 'fill-svg-disabled/50'}
        >
      ...
      <li
        className={`flex gap-4 md:order-3 ${
          data.blog ? 'text-svg' : 'text-svg-disabled/50 italic'
        }`}
      >
        <svg
          height='20'
          width='20'
          xmlns='http://www.w3.org/2000/svg'
          className={data.blog ? 'fill-svg' : 'fill-svg-disabled/50'}
        >
          <g>
        ...
        {data.blog === '' ? (
          ...
          <a href={data.blog ?? '#'} target='_blank' className=' hover:underline'>
            {data.blog}{' '}
          </a>
        )}
      </li>
      <li
        className={`flex gap-4 md:order-2 ${
          data.twitter_username ? 'text-svg' : 'text-svg-disabled/50 italic'
        }`}
      >
        <svg
          height='18'
          width='20'
          xmlns='http://www.w3.org/2000/svg'
          className={data.twitter_username ? 'fill-svg' : 'fill-svg-disabled/50'}
        >
      ...
      <li
        className={`flex gap-4 md:order-4 ${
          data.company ? 'text-svg' : 'text-svg-disabled/50 italic'
        }`}
      >
        <svg
          height='20'
          width='20'
          xmlns='http://www.w3.org/2000/svg'
          className={data.company ? 'fill-svg' : 'fill-svg-disabled/50'}
        >
          <g>
        ...
        {data.company ? (
          <a href={`https://github.com/${data.company.replace(/^@/, '')}`} target='_blank'>
            {data.company}
          </a>
        ) : (
          'Not available'
